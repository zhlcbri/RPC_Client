	...
	/* [in] */ CONTEXT_HANDLE hContext)
{
	...
	NdrClientCall2(
		(PMIDL_STUB_DESC)&Example1_StubDesc,
		(PFORMAT_STRING)&Example1__MIDL_ProcFormatString.Format[40],
	...
	/* [out][in] */ CONTEXT_HANDLE *phContext)
{
	...
	NdrClientCall2(
		(PMIDL_STUB_DESC)&Example1_StubDesc,
		(PFORMAT_STRING)&Example1__MIDL_ProcFormatString.Format[76],
...
#endif /* #if !defined(_M_IA64) && !defined(_ARM_) && defined(_M_AMD64) */
